...
class TaskRepository:
    ...
    async def get_user_task(self, user_id: int, task_id: uuid.UUID) -> Optional[UserTask]:
    ...
    async def create_or_update_user_task(self, user_task: UserTask) -> UserTask:
    ...
    async def get_completed_user_tasks(self, user_id: int) -> List[UserTask]:
