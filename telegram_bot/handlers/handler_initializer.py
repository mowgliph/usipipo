...
from telegram_bot.features.admin.handlers_admin import get_admin_handlers, get_admin_callback_handlers
from telegram_bot.features.achievements.handlers_achievements import get_achievements_handlers, get_achievements_callback_handlers
from telegram_bot.features.ai_support.handlers_ai_support import get_ai_support_handlers, get_ai_support_callback_handlers
from telegram_bot.features.announcer.handlers_announcer import get_announcer_handlers, get_announcer_callback_handlers
from telegram_bot.features.broadcast.handlers_broadcast import get_broadcast_handlers, get_broadcast_callback_handlers
from telegram_bot.features.game.handlers_game import get_game_handlers, get_game_callback_handlers
from telegram_bot.features.key_management.handlers_key_management import get_key_management_handlers, get_key_management_callback_handlers
from telegram_bot.features.operations.handlers_operations import get_operations_handlers, get_operations_callback_handlers
from telegram_bot.features.payments.handlers_payments import get_payments_handlers, get_payments_callback_handlers
from telegram_bot.features.referral.handlers_referral import get_referral_handlers, get_referral_callback_handlers
from telegram_bot.features.shop.handlers_shop import get_shop_handlers, get_shop_callback_handlers
from telegram_bot.features.support.handlers_support import get_support_handlers, get_support_callback_handlers
from telegram_bot.features.task_management.handlers_task_management import get_task_management_handlers, get_task_management_callback_handlers
from telegram_bot.features.user_management.handlers_user_management import get_user_management_handlers, get_user_management_callback_handlers
from telegram_bot.features.vip.handlers_vip import get_vip_handlers, get_vip_callback_handlers
from telegram_bot.features.vpn_keys.handlers_vpn_keys import get_vpn_keys_handlers, get_vpn_keys_callback_handlers
...
def initialize_handlers(
    ...
    try:
        # Admin handlers (require admin service, which we'll create inline)
        ...
        handlers.extend(get_ai_support_handlers(ai_support_service))
        handlers.extend(get_ai_support_callback_handlers(ai_support_service))
        logger.info("✅ Handlers de soporte IA configurados")
        
        # Announcer handlers
        handlers.extend(get_announcer_handlers())
        handlers.extend(get_announcer_callback_handlers())
        logger.info("✅ Handlers de anunciador configurados")
        
        # Broadcast handlers
        handlers.extend(get_broadcast_handlers())
        handlers.extend(get_broadcast_callback_handlers())
        logger.info("✅ Handlers de difusión configurados")
        
        # Game handlers
        handlers.extend(get_game_handlers())
        handlers.extend(get_game_callback_handlers())
        ...
        handlers.extend(get_task_management_handlers())
        handlers.extend(get_task_management_callback_handlers())
        logger.info("✅ Handlers de gestión de tareas configurados")
        
        # User management handlers
        handlers.extend(get_user_management_handlers())
        handlers.extend(get_user_management_callback_handlers())
